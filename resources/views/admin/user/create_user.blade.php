...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @endif
            <form id="frUser" data-parsley-validate action="{{url('admin/user/0')}}"
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" id="username"  required maxlength="255">
                    </div>
                    <div class="form-group">
                        <label for="introduce">
                            Email
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <img id="imgF" src="{{asset('images/user')}}" class="img-responsive" style="height: 200px;">
                    </div>
                </div>
            </form>
            </div>
