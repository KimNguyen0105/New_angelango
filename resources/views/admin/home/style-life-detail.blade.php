    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="row" style="background-color: #fff; padding: 10px 30px; margin-bottom: 10px">
                        <h3>Thông tin thời trang và cuộc sống</h3>
                </div>
            ...
            @endif
            <form id="demo-form2" data-parsley-validate action="{{url('admin/style-life/0')}}"
                ...
                <div class="row" style="padding: 10px 30px; margin-bottom: 10px; border-bottom: 2px #9a9999 solid;">
                    <a href="{{url('admin/style-life')}}" class="btn btn-primary" type="button">Cancel</a>
