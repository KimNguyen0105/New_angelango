...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @endif
            <form id="frGuide" data-parsley-validate action="{{url('admin/guide')}}/{{$guide->id}}"
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_vi">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_vi" id="title_vi" value="{{$guide->title_vi}}" required maxlength="255">
                                </div>
                                <div class="form-group">
                                    <label for="introduce">
                                        Nội dung
                                    </label>
                                    <textarea class="form-control editors" name="content_vi" required id="introduce_vi" rows="3">{{$guide->content_vi}}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_en">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_en" id="title_en" value="{{$guide->title_en}}" required maxlength="255">
                                </div>
                                <div class="form-group">
                                    <label for="introduce">
                                        Content
                                    </label>
                                    <textarea class="form-control editors" name="content_en" required id="introduce_en" rows="3">{{$guide->content_en}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="sort_order" id="sort_order" value="{{$guide->sort_order}}" required maxlength="255">
                    </div>
                </div>
            </form>
            </div>
