...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @endif
            <form id="frSlide" data-parsley-validate action="{{url('admin/slide/0')}}"
                ...
                <div class="row" style="padding: 10px 30px; margin-bottom: 10px; border-bottom: 2px #9a9999 solid;">
                    <a href="{{url('admin/slide')}}" class="btn btn-primary" type="button">Cancel</a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="form-control" name="is_show" id="is_show">
                    </div>
                    <div class="form-group">
                        <label class="control-label">Hình ảnh(1700 x 700)</label>
                        <input id="file" accept="image/*" name="file" required type="file" style="padding-bottom: 20px" onchange="readURL(this);">
                        <img id="imgF" src="{{asset('images/slide')}}" class="img-responsive" style="height: 200px;">
                    </div>
                </div>
            </form>
            </div>
