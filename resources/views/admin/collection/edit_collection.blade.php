                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_vi">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_vi" id="title_vi" value="{{$collection->title_vi}}" required maxlength="255">
                                </div>
                                <div class="form-group">
                                    <label for="introduce">
                                        Nội dung
                                    </label>
                                    <textarea class="form-control editors" name="content_vi" required id="introduce_vi" rows="3">{{$collection->content_vi}}</textarea>
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_en">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title_en" id="title_en" value="{{$collection->title_en}}" required maxlength="255">
                                </div>
                                <div class="form-group">
                                    <label for="introduce">
                                        Content
                                    </label>
                                    <textarea class="form-control editors" name="content_en" required id="introduce_en" rows="3">{{$collection->content_en}}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
