...
@section('content')
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            @endif
            <form id="demo-form2" data-parsley-validate action="{{url('admin/menu-product/create-menu-product')}}"
                ...
                <div class="row" style="padding: 10px 30px; margin-bottom: 10px; border-bottom: 2px #9a9999 solid;">
                    <a href="{{url('admin/menu-product')}}" class="btn btn-primary" type="button">Cancel</a>
